...
<?php
    ...
    $query .= " WHERE `title` LIKE '%" . $smtxt . "%'";
?>
    <div id="center" class="center_o pt-4 pb-4 bg-light">
        <div class="container-xl">
            <div class="row center_o1 text-center">
                <div class="col-md-12">
                    <h1 style="text-transform: uppercase">Search Results "<span><?php echo $smtxt; ?></span>"</h1>
            ...
            <div class="col-md-3 col-sm-4" style="padding-top: 8px;">
                <div class="single-new-arrival bg-light">
                    ...
                    <div class="pt-4 pb-4 ps-3 pe-3 clearfix">
                        ...
                        <hr>
                        <h6 class="fw-normal mb-0 pull-right fw-bold col_yell">$68.00</span></h6>
                    </div>
                </div>
            </div>
